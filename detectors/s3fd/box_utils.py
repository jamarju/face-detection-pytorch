...
class Detect(Function):
    ...
    def forward(ctx, loc_data, conf_data, prior_data, num_classes=2, top_k=750, nms_thresh=0.3, conf_thresh=0.05, variance=[0.1, 0.2], nms_top_k=5000):
        num = loc_data.size(0)
        ...
        decoded_boxes = decode(loc_data.view(-1, 4), batch_priors, variance)
        ...
        for i in range(num):
            ...
            for cl in range(1, num_classes):
                ...
                ids, count = nms(boxes_, scores, nms_thresh, nms_top_k)
